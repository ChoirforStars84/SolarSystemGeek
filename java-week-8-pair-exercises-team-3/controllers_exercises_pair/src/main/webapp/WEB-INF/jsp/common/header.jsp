...
<body>
    ...
    <nav>
        ...
        <ul>
            <li><a href="/ssg-exercises-pair/alienAge#">Alien Age</a></li>
            <li><a href="/ssg-exercises-pair/alienWeight#">Alien Weight</a></li>
            <li><a href="/ssg-exercises-pair/alienDriveTime#">Drive Time</a></li>               
        </ul>
    </nav>